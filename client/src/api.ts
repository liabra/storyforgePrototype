const BASE = (import.meta.env.VITE_API_URL ?? "https://storyforgeprototype-production.up.railway.app") + "/api";
...
export const api = {
  auth: {
    register: (password: string, email?: string, pseudonym?: string) =>
      request<AuthResponse & { recoveryCode?: string }>("/auth/register", {
        method: "POST",
